...
#import "c:\Program Files (x86)\Common Files\System\ado\msado15.dll" no_namespace rename("EOF","EndOfFile") //rename("BOF","EOfFile")
...
public:
	...
	static BOOL RefreshCache(_Connection *pconn);
...
public:
	...
	void SetPrecision(int nPrecision)
		{m_pParameter->PutPrecision((unsigned char)nPrecision);};
	void SetScale(int nScale)
		{m_pParameter->PutNumericScale((unsigned char)nScale);};
