...
#ifdef CPING_USE_ICMP
BOOL CPing::Ping1(LPCTSTR pszHostName, CPingReply& pr, UCHAR nTTL, DWORD dwTimeout, WORD nPacketSize) const
{
	//For correct operation of the T2A macro, see TN059
	USES_CONVERSION;
	//Make sure everything is initialised
...
//	if(nRecvPackets==0)	
//	{
//		nRecvPackets=GetLastError();
//	}
//	temp.Format("1Packetsize:%d",nRecvPackets);
	//ShowUIMessage(temp);
